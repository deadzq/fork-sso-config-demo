sso-server bootstrap.properties指定dev或prod环境
启动sso-config/SsoConfigApplication

启动sso-server,可通过config下的不同sso-xxx.properties文件获取配置
*启动sso-server:切换到sso-server,执行build.cmd run
